...
import {Form, Checkbox, Switch, Select, Button, Spin} from 'antd'
    ...
    return (
        ...
        <Form horizontal onSubmit={handleSubmit}>
            ...
            <FormItem {...formItemLayout} label="允许用户注册" help="如果此项被禁用，只能由管理员通过用户管理页面添加用户">
                ...
                })(<Switch onChange={onShowControls}></Switch>)}
            </FormItem>
            <FormItem {...formItemLayout} label="注册用户默认激活" help="如果此项被选，新用户需要通过邮件激活后才能登录"
            ...
            <FormItem {...formItemLayout} label="用户注册时使用图片验证码"
                      style={{display: settings.showControls ? '' : 'none'}}>
